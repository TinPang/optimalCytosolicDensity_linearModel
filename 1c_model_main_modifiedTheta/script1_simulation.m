...
arr_occupancy = 0.005:0.005:0.995;  % range of occupancy rho to consider
arr_ratio_s = 10.^(-3:0.001:-0.001);  % range of volume ratio (between enzyme and substrate) to consider
